...
export async function generateMetadata() {
    ...
    return {
        ...
        title: {
            default:
                settings?.metaTitle ||
                "Smart Panel Nepal | Prefab Panel Nepal Pvt. Ltd. | The Smart Way to Build",
...
export default function RootLayout({ children }) {
    ...
    // Falls back to the ID you gave me so GA still runs even if db.json isn't filled yet
    const gaId = settings?.googleAnalyticsId || "G-HCV8C3MX6H";
    ...
    const jsonLd = {
        ...
        address: {
            "@type": "PostalAddress",
            streetAddress: "Pepsicola-32, Kathmandu, Nepal",
            addressLocality: "Kathmandu, Nepal, Kathmandu Valley",
        ...
        location: [
            {
                ...
                address: {
                    "@type": "PostalAddress",
                    streetAddress: "Pepsicola-32, Kathmandu",
