...
const CARDS = [
  { key: "heroSlides", label: "Homepage Slides", href: "/admin-dashboard/slides" },
  { key: "products", label: "Products", href: "/admin-dashboard/products" },
  { key: "gallery", label: "Gallery Photos", href: "/admin-dashboard/gallery" },
  { key: "notices", label: "Notices", href: "/admin-dashboard/notices" },
  { key: "investorRelations", label: "Investor Documents", href: "/admin-dashboard/investor" },
  { key: "catalogue", label: "Catalogue Files", href: "/admin-dashboard/catalogue" },
  { key: "messages", label: "Contact Messages", href: "/admin-dashboard/messages" },
  { key: "newsletterSubs", label: "Newsletter Subscribers", href: "/admin-dashboard/subscribers" },
  { key: "dealershipInquiries", label: "Dealership Leads", href: "/admin-dashboard/dealership-leads" },
];
