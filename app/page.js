    ...
    <div>
      ...
      <section className="py-8 sm:py-10 lg:py-16">
        <div className="container-page grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 mt-4 lg:mt-0 flex flex-col items-center text-center lg:items-start lg:text-left">
            <span className="text-xs uppercase tracking-widest text-brand-orange font-bold text-center lg:text-left">Who We Are</span>
            <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-extrabold text-brand-blue-dark mt-1 leading-tight text-center lg:text-left">
              {settings.companyName}
            </h2>
            <p className="mt-3 sm:mt-5 text-gray-600 leading-relaxed text-xs sm:text-sm md:text-base text-center lg:text-left">{settings.aboutSummary}</p>
      ...
      <section className="py-10 md:py-16 lg:py-20 bg-gray-50/80 border-t border-b border-gray-100">
        <div className="container-page">
          <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-12">
            ...
            <div className="w-16 sm:w-20 h-1 bg-brand-orange mx-auto mt-3 rounded-full" />
            <div className="mt-4 flex items-center justify-center gap-1.5 sm:gap-2 text-[11px] sm:text-xs font-bold text-gray-600 bg-white border border-gray-200 inline-flex px-3 sm:px-4 py-1.5 rounded-full shadow-xs text-center max-w-full">
      ...
      <section className="py-10 md:py-16 lg:py-20 bg-white">
        <div className="container-page">
          <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-12">
            ...
            <div className="w-16 sm:w-20 h-1 bg-brand-orange mx-auto mt-3 rounded-full" />
            <p className="text-xs sm:text-sm text-gray-600 mt-3">Common queries about prefab house price, insulation, and earthquake safety in Nepal.</p>
          </div>
