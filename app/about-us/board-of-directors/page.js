...
export const metadata = { title: "Board of Directors | Smart Panel Nepal" };
...
export default function BoardPage() {
  ...
  return (
    <div>
      <PageHero crumb="About Us" title="Board of Directors" subtitle="Meet the board guiding Smart Panel's long-term strategy, corporate governance, and nationwide expansion." />
