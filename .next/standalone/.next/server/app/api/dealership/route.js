"use strict";(()=>{var e={};e.id=7173,e.ids=[7173],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2048:e=>{e.exports=require("fs")},5315:e=>{e.exports=require("path")},5218:e=>{e.exports=require("node:child_process")},6005:e=>{e.exports=require("node:crypto")},604:e=>{e.exports=require("node:dns")},5673:e=>{e.exports=require("node:events")},7561:e=>{e.exports=require("node:fs")},8849:e=>{e.exports=require("node:http")},2286:e=>{e.exports=require("node:https")},7503:e=>{e.exports=require("node:net")},612:e=>{e.exports=require("node:os")},9411:e=>{e.exports=require("node:path")},4492:e=>{e.exports=require("node:stream")},1764:e=>{e.exports=require("node:tls")},3020:e=>{e.exports=require("node:url")},7261:e=>{e.exports=require("node:util")},5628:e=>{e.exports=require("node:zlib")},5295:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>x,patchFetch:()=>m,requestAsyncStorage:()=>f,routeModule:()=>c,serverHooks:()=>g,staticGenerationAsyncStorage:()=>u});var o={};r.r(o),r.d(o,{POST:()=>l});var n=r(9303),a=r(8716),s=r(3131),i=r(7070),p=r(4191),d=r(2546);async function l(e){try{let{name:t,email:r,phone:o,location:n,message:a}=await e.json();if(!t||!r||!o||!n)return i.NextResponse.json({error:"Missing required fields"},{status:400});let s={id:(0,p.pZ)(),name:t,email:r,phone:o,location:n,message:a||"",date:new Date().toISOString()};return(0,p.l6)(e=>{e.dealershipInquiries=e.dealershipInquiries||[],e.dealershipInquiries.unshift(s)}),(0,d.J)({name:t,email:r,phone:o,location:n,message:a}).catch(e=>{console.error("Error triggering dealership notification:",e)}),i.NextResponse.json({ok:!0})}catch(e){return console.error("Dealership API Error:",e),i.NextResponse.json({error:"Internal Server Error"},{status:500})}}let c=new n.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/dealership/route",pathname:"/api/dealership",filename:"route",bundlePath:"app/api/dealership/route"},resolvedPagePath:"D:\\web apps\\sypanel-nextjs\\app\\api\\dealership\\route.js",nextConfigOutput:"standalone",userland:o}),{requestAsyncStorage:f,staticGenerationAsyncStorage:u,serverHooks:g}=c,x="/api/dealership/route";function m(){return(0,s.patchFetch)({serverHooks:g,staticGenerationAsyncStorage:u})}},4191:(e,t,r)=>{r.d(t,{CZ:()=>p,l6:()=>d,pZ:()=>l});var o=r(2048),n=r.n(o),a=r(5315),s=r.n(a);function i(){for(let e of[s().join(process.cwd(),"data","db.json"),s().join(process.cwd(),"smart-panel","data","db.json"),s().join(__dirname,"..","data","db.json"),s().join(__dirname,"..","..","data","db.json"),s().resolve("data","db.json")])if(n().existsSync(e))return e;return s().join(process.cwd(),"data","db.json")}function p(){try{let e=i(),t=n().readFileSync(e,"utf-8");return JSON.parse(t)}catch(e){return console.error("Error reading db.json:",e),{settings:{},advantages:[],servicesList:[],products:[],notices:[],heroSlides:[],reviews:[],projects:[],processSteps:[],faqs:[],governmentRates:[],additionalRates:[],technicalData:[],installationTools:[],sectors:[],about:{chairperson:{name:"",title:"",image:"",message:""},story:"",mission:"",vision:"",whatWeStandFor:[],boardOfDirectors:[],management:[]},gallery:[],catalogue:[],investorRelations:[],dealershipInquiries:[],messages:[],newsletterSubs:[]}}}function d(e){let t=p(),r=e(t);return function(e){let t=i();n().writeFileSync(t,JSON.stringify(e,null,2),"utf-8")}(t),r}function l(){return Date.now().toString(36)+Math.random().toString(36).slice(2,7)}},2546:(e,t,r)=>{r.d(t,{J:()=>s,L:()=>a});var o=r(8892);function n(){let e=process.env.SMTP_HOST||"mail.prefabpanelnepal.com",t=parseInt(process.env.SMTP_PORT||"465",10),r="false"!==process.env.SMTP_SECURE&&465===t,n=process.env.SMTP_USER||"contact@prefabpanelnepal.com",a=process.env.SMTP_PASS||"";return a?o.ZP.createTransport({host:e,port:t,secure:r,auth:{user:n,pass:a},tls:{rejectUnauthorized:!1}}):(console.warn("SMTP_PASS is not configured. Email notification skipped."),null)}async function a({name:e,email:t,phone:r,message:o}){try{let a=n();if(!a)return!1;let s=`"Smart Panel Website" <${process.env.SMTP_USER||"contact@prefabpanelnepal.com"}>`,i=process.env.SMTP_TO||"contact@prefabpanelnepal.com, info@prefabpanelnepal.com",p={from:s,to:i,replyTo:t,subject:`New Contact Inquiry from ${e} - Smart Panel`,html:`
      ...
      `};return await s.sendMail(d),!0}catch(e){return console.error("Failed to send dealership email notification:",e),!1}}}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),o=t.X(0,[8948,5972,8892],()=>r(5295));module.exports=o})();